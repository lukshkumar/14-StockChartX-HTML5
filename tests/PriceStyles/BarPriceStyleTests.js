...
BarPriceStyleTestCase = TestCase('BarPriceStyleTestCase', {
    setUp: function() {
        "use strict";

        this.target = new StockChartX.BarPriceStyle();
    },

    testClassName: function() {
        "use strict";

        assertEquals("Class name is not set properly.", "bar", StockChartX.BarPriceStyle.className);
    },
    ...
    testCreatePlot: function() {
        ...
        assertEquals("Plot style is not set properly.", StockChartX.BarPlot.Style.OHLC, actual.plotStyle);
