...
HollowCandlePriceStyleTestCase = TestCase('HollowCandlePriceStyleTestCase', {
    setUp: function() {
        "use strict";

        this.target = new StockChartX.HollowCandlePriceStyle();
    },

    testClassName: function() {
        "use strict";

        assertEquals("Class name is not set properly.", "hollowCandle", StockChartX.HollowCandlePriceStyle.className);
    },
    ...
    testCreatePlot: function() {
        ...
        assertEquals("Plot style is not set properly.", StockChartX.BarPlot.Style.HOLLOW_CANDLE, actual.plotStyle);
