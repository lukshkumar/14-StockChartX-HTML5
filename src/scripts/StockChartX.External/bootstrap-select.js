...
var Selectpicker = (function() {
  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function() {
      ...
      var inputGroup = this.$element.parent().hasClass("input-group")
        ? " input-group-btn"
        : "";
    ...
    liHeight: function() {
      ...
      var $selectClone = this.$menu
        ...
        searchHeight = this.options.liveSearch
          ? $menuClone.find(".bootstrap-select-searchbox").outerHeight()
          : 0,
    ...
    selectPosition: function() {
      ...
      this.$newElement.on("click", function() {
        ...
        $drop.appendTo(HtmlContainer.instance.componentsContainer);
      ...
      $("html").on("mousedown", function(e) {
        if ($(".bootstrap-select").has(e.target).length === 0)
          $drop.removeClass("open");
      });
