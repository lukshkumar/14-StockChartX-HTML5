...
export interface tinycolor {
   ...
   */
  readability(
    firstColor: tinycolorInstance,
    secondColor: tinycolorInstance
  ): Readable.Readable;
   ...
   */
  isReadable(
    foreColor: tinycolorInstance,
    backColor: tinycolorInstance
  ): boolean;
  ...
  mostReadable(
    ...
    colorsToCompare: tinycolorInstance[]
  ): tinycolorInstance;

  /**/
  mix(
    color1: tinycolorInstance,
    color2: tinycolorInstance,
    amount?: number
  ): tinycolorInstance;
